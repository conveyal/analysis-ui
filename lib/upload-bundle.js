    ...
    return (
      <Modal
        ...
        <form
          ...
          <input type='hidden' name='scenarioId' value='changeme' />
          {this.state.uploading ? <span><i className='fa fa-spin fa-spinner'></i>&nbsp;Uploading&nbsp;.&nbsp;.&nbsp;.</span> : <input className='btn btn-success' type='submit' value='Upload' />}
        </form>
      </Modal>
    )
  }
