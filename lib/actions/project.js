  ...
  dispatch(fetch({
    ...
    next (response) {
      ...
      if (project.analysisRequestSettings) {
        ...
        if (project.analysisRequestSettings.opportunityDatasetId) {
          dispatch(OpportunityDatasets.actions.setActiveOpportunityDataset(
            project.analysisRequestSettings.opportunityDatasetId
          ))
        }
