...
const saveToServer = (project: Project, customOpenStreetMapData: ?File, method: string) => {
...
export const create = (project: Project, customOpenStreetMapData: ?File) => {
  project.id = uuid.v4()
...
export const save = (project: Project, customOpenStreetMapData: ?File) => [
  setLocally(project),
