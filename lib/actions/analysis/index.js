...
export const fetchTravelTimeSurface = () => (dispatch, getState) => {
  ...
  if (profileRequests[0].percentiles == null) {
    profileRequests[0].percentiles = TRAVEL_TIME_PERCENTILES
  }
  ...
  if (get(requestsSettings, '[1].projectId') != null) {
    ...
    if (profileRequests[1].percentiles == null) {
      profileRequests[1].percentiles = TRAVEL_TIME_PERCENTILES
    }
  }
