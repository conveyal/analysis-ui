...
export const fetchIsochrone = ({ scenarioId, bundleId, modifications, isochroneCutoff, origin }) => {
  return [
    ...
    getIsochronesAndAccessibility({ scenarioId, bundleId, modifications, isochroneCutoff, origin })
      .then(({ isochrone, accessibility }) => [setIsochroneResults({ isochrone, accessibility }), setIsochroneFetchStatus(false)])
  ]
}
