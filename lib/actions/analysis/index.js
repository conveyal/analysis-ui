...
/** Sets the comparison project ID */
...
export const fetchTravelTimeSurface = () =>
  (dispatch: Dispatch, getState: GetState) => {
    ...
    const fetches = []
    fetches.push({
      url: SINGLE_POINT_URL,
      options: {
        method: 'post',
        body: {
          ...body,
          projectId: currentProjectId,
          variantIndex: state.analysis.activeVariant
        }
      },
      retry
    })
    ...
    if (comparisonInProgress && !compareToStraightLineDistance) {
      fetches.push({
        ...
        options: {
          ...
          body: {
            ...body,
            projectId: state.analysis.comparisonProjectId,
            variantIndex: state.analysis.comparisonVariantIndex
          }
        },
        retry
      })
