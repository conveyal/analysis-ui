...
export const copyPrimarySettings = createAction('copy primary settings')
...
const getStoredSettings = () => {
  return JSON.parse(localStorage.getItem(requestsSettingsKey) || '{}')
}
...
export const storeRequestsSettings = (requestsSettings) => (
  ...
  try {
    ...
    localStorage.setItem(requestsSettingsKey, JSON.stringify(storedSettings))
  } catch (e) {
