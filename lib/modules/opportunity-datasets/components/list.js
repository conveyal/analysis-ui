...
type Props = {
  ...
  downloadLODES: (regionId: string) => void,
    ...
    return <div>
      ...
      <Group>
        ...
        <Button
          ...
          style='primary'
          title={message('opportunityDatasets.downloadLODES', 'Download LODES for Region')}
          ><Icon type='download' /> {message('opportunityDatasets.downloadLODES', 'Download LODES')}
        </Button>
      </Group>
    ...
    {status.status === 'UPLOADING' &&
      <p>
        {message('opportunityDatasets.uploadProgress', {
          ...
          completed: status.completedGrids,
          total: status.totalGrids
        })}
      </p>}
