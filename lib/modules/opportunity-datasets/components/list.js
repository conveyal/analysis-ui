...
export class ListOpportunityDatasets extends PureComponent {
  ...
  _deleteDataset = () => {
    ...
    if (window.confirm('Are you sure you would like to delete this dataset?') && activeOpportunityDataset) {
  ...
  _deleteSourceSet = () => {
    const {activeOpportunityDataset} = this.props
    if (window.confirm('Are you sure you would like to delete all opportunity datasets from this source?') && activeOpportunityDataset) {
  ...
  render () {
    ...
    return <div>
      ...
      {activeOpportunityDataset && activeOpportunityDataset._id &&
        <Group>
          <Button
            block
          ...
          <Button
            ...
            style='danger'
            title='Delete entire dataset source'
            ><Icon type='trash' /> Delete entire dataset source
          </Button>
        </Group>}
      {activeOpportunityDataset && activeOpportunityDataset._id &&
...
export default connect(createStructuredSelector(select), {
  ...actions,
  goToUpload: actions.createGoTo('/upload')
