    ...
    return (
      <div>
        <div>
          ...
          <button className='btn btn-sm btn-block btn-warning' onClick={this.editOnMap}>Edit route geometry</button>
        ...
        <div>
          ...
          <button className='btn btn-default' onClick={this.newTimetable}>Add timetable</button>
        </div>
      </div>
      )
  }
