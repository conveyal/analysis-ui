...
const contains = (width, height) => (x, y) => x >= 0 && y >= 0 && x < width && y < height
...
describe('Selectors > aggregation accessibility', () => {
  it('should work', () => {
    ...
    const population = {
      ...
      data: [10000, 100,   25, // <== aggregation area overlaps rightmost two cells
             10000, 10000, 10000]
    }
    ...
    const accessibility = {
      ...
      data: [100, 100, 100,  100,
             100, 100, 100,  100,
             100, 100, 1000, 5500, // <== rightmost two overlap aggregation area
             100, 100, 100,  100]
    }
    ...
    const aggregateAccessibility = getAggregateAccessibility(accessibility, aggregationArea, population)
