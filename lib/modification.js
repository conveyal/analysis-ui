...
class Modification extends Component {
  ...
  renderExpanded () {
    const {allVariants, feeds, feedsById, modification, mapState, setActiveTrips, setMapState, type, variants} = this.props
    const props = {
      feeds,
      feedsById,
      mapState,
