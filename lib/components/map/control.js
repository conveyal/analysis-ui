...
export default class Control extends Component {
  ...
  _refreshIsochrones = () => {
    const {clearIsochroneResults, isochroneLatLng, setIsochroneLatLng} = this.props
    clearIsochroneResults()
    setIsochroneLatLng({...isochroneLatLng})
  }
      ...
      <div className='MapControl'>
        ...
        {!isFetchingIsochrone && isShowingIsochrone &&
          <div className='Isochrone'>
            ...
            <a
              className='block'
              onClick={this._refreshIsochrones}
