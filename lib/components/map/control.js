...
export default class Control extends Component {
  ...
  doFetchIsochrone = (opts) => this.props.fetchIsochrone(opts)
  ...
  _setIsochroneCutoff = (e) => {
    const {bundleId, isochroneLatLng, modifications, scenarioId, setIsochroneCutoff} = this.props
