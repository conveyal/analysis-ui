...
import type {LonLat, Quintiles, LeafletMarker} from '../../types'
...
export default class DestinationTravelTimeDistribution extends DeepEqualComponent<void, Props, void> {
  render () {
    const {destination, destinationTravelTimeDistribution, comparisonDestinationTravelTimeDistribution, isFetchingIsochrone, remove} = this.props
    ...
    // popups
    return <DraggablePopup position={destination} maxWidth={WIDTH + 10} drag={this.drag} remove={remove}>
      <figure>
