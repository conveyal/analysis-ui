...
import {fromLatLngBounds, toLatLngBounds, reprojectBounds} from '../utils/bounds'
...
export default class CreateRegion extends Component {
  ...
  _create = () => {
    ...
    this.props.create({
      ...this.state,
      bounds: fromLatLngBounds(reprojectBounds(this.state.bounds))
    })
  }
      ...
      <Application map={this._map}>
        ...
        <Dock>
          ...
          <div className='alert alert-warning'>
            ...
            <a href='http://docs.analysis.conveyal.com/en/latest/analysis/methodology.html#spatial-resolution' target='_blank'> Learn more about spatial resolution here.</a>
          </div>
          ...
          <div className='alert alert-info all-copy'>
            {`osmconvert [file].pbf -b="${bounds.getWest()}, ${bounds.getSouth()}, ${bounds.getEast()}, ${bounds.getNorth()}" --complete-ways -o=[file]-cropped.pbf`}
          </div>
