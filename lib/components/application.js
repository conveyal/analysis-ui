...
function UiLock ({clearError, error, errorMessage}) {
  return (
    <Modal
      ...
      <ModalBody>
        <p>To submit an error report email a screenshot of your browser window and a description of what you were doing to <a href='mailto:analysis@conveyal.com' title='Conveyal Support'>analysis@conveyal.com</a></p>
        <ul>
