  ...
  render () {
    ...
    return (
      <div>
        ...
        >
          {uploadFailed &&
            <div className='alert alert-danger'>Upload Failed. Is this a valid GTFS bundle? <br />{uploadFailed}</div>}
          ...
          <button
            ...
            type='submit'
          >{uploading ? <span><Icon className='fa-spin' type='spinner' /> Processing...</span> : messages.bundle.create}
          </button>
        </form>
      </div>
    )
