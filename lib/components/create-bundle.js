    ...
    <InnerDock style={{width: '640px'}}>
      <form encType='multipart/form-data' onSubmit={submit}>
        <Stack p={8} spacing={8}>
          ...
          <Stack spacing={4}>
            <Heading size='md'>{message('bundle.osm.title')}</Heading>

            <Text>{message('bundle.osm.description')}</Text>
            ...
            {formData.osm || (
              <FormControl isDisabled={uploading}>
                <FormLabel htmlFor='osmId'>
                  {message('bundle.osm.existingLabel')}
                </FormLabel>
            ...
            {formData.osmId || (
              <FormControl isDisabled={uploading}>
                ...
                />
                <FormHelperText>
                  {message('bundle.osm.uploadNewHelp')}
                </FormHelperText>
              </FormControl>
            )}
          </Stack>
          ...
          <Stack spacing={4}>
            <Heading size='md'>{message('bundle.gtfs.title')}</Heading>

            <Text>{message('bundle.gtfs.description')}</Text>

            {formData.feedGroup || (
              <FormControl isDisabled={uploading}>
                <FormLabel htmlFor='feedGroupId'>
                  {message('bundle.gtfs.existingLabel')}
                </FormLabel>
                <Select
                  id='feedGroupId'
                  name='feedGroupId'
            ...
            {formData.feedGroupId || (
              <FormControl isDisabled={uploading}>
                ...
                />
                <FormHelperText>
                  {message('bundle.gtfs.uploadNewHelp')}
                </FormHelperText>
              </FormControl>
            )}
          </Stack>
