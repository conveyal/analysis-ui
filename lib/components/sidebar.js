    ...
    return (
      <div className='Sidebar'>
        ...
        {regionId && regionId !== CREATING_ID && (
          <div>
            <ItemLink
              active={PATHS.regionSettings === p.pathname}
              icon={faMap}
            ...
            />
            <ItemLink
              active={PATHS.projects === p.pathname}
              icon={faCubes}
            ...
            />
            <ItemLink
              active={p.pathname.startsWith('/bundle')}
              icon={faDatabase}
            ...
            />
            <ItemLink
              active={p.pathname.startsWith('/opportunities')}
              icon={faTh}
            ...
            {projectId ? (
              <ItemLink
                active={p.pathname.startsWith('/modification')}
                icon={faPencilAlt}
            ...
            <ItemLink
              active={p.pathname.startsWith('/analysis')}
              icon={faChartArea}
            ...
            />
            <ItemLink
              active={p.pathname.startsWith(PATHS.regionalAnalysis)}
              icon={faServer}
...
const ItemContents = p => (
  <a className='Sidebar-navItem-contents' {...p}>
    <Icon icon={p.icon} fixedWidth />
...
const ItemLink = p => {
  ...
  return (
    <Tip className={className} tip={p.text}>
      <Link href={p.href}>
        <ItemContents icon={p.icon} text={p.text} />
      </Link>
    </Tip>
  )
}
const ExternalLink = p => (
  <Tip className='Sidebar-navItem' tip={p.text}>
    <ItemContents href={p.href} icon={p.icon} target='_blank' text={p.text} />
  </Tip>
)
