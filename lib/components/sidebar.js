  ...
  return (
    ...
    >
      ...
      {regionId && regionId !== CREATING_ID && (
        <>
          <ItemLink
            active={pathname.startsWith(RouteTo.regionSettings)}
            icon={faMap}
          ...
          />
          <ItemLink
            active={pathname.startsWith(RouteTo.projects)}
            icon={faCubes}
          ...
          />
          <ItemLink
            active={pathname.startsWith('/regional')}
            icon={faServer}
...
const ItemLink = p => {
  ...
  return (
    <Tip className={className} tip={p.text}>
      <Link to={p.link.to} {...get(p, 'link.query', {})}>
