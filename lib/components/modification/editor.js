...
export default class ModificationEditor extends React.PureComponent {
  ...
  _removeFeed = () => {
    ...
    if (modification) {
      ...
      if (hasOwnProperty(modification, 'routes')) update.routes = null
      if (hasOwnProperty(modification, 'stops')) update.stops = null
      if (hasOwnProperty(modification, 'trips')) update.trips = null
      if (hasOwnProperty(modification, 'fromStop')) update.fromStop = null
      if (hasOwnProperty(modification, 'toStop')) update.toStop = null
