...
import {Checkbox, Text, TextArea} from '../input'
...
export default class ModificationEditor extends Component<void, Props, void> {
  ...
  _onDescriptionChange = (e: Event & {currentTarget: HTMLInputEvent}) => {
    this.props.update({ ...this.props.modification, description: e.currentTarget.value })
  }
  ...
  componentWillMount () {
    this.setState({ showDescription: !!this.props.modification.description })
  }
