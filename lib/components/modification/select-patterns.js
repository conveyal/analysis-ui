...
import type {ReactSelectMultiOptions} from '../../types'
...
type Props = {
  ...
  trips?: string[] // trips can be null indicating a wildcard
}
...
export default class SelectPatterns extends PureComponent<void, Props, void> {
  selectPatterns = (selectedPatterns: ReactSelectMultiOptions) => {
