...
export default class ModificationsList extends Component {
  ...
  static getDerivedStateFromProps (props, state) {
    return {
      filteredModificationsByType: filterModifications({
        filter: state.filter,
        ...
        <Dock>
          ...
          <Group>
            <Button
              ...
              style='success'
            >
              <Icon type='plus' />{message('modification.create')}
            </Button>
          </Group>
