...
import type {Modification, Scenario} from '../../types'
...
export default class ModificationsList extends Component {
  ...
  _createModification = () => {
    ...
    this.setState({newModificationName: ''})
  ...
  _goToEditModification = (id: string) => {
    const {push, scenarioId} = this.props
    push(`/scenarios/${scenarioId}/modifications/${id}`)
  }
          ...
          <div className='block'>
            ...
            {modifications.length === 0 &&
              <Button
                ...
                style='success'
              >
                <Icon type='plus' /> Create your first modification
              </Button>}
          </div>
