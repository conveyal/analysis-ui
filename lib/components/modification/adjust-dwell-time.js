...
import type {AdjustDwellTime, Feed, MapState, RoutePatterns, Stop} from '../../types'

type Props = {
  feeds: Feed[],
  modification: AdjustDwellTime,
 ...
 * Change dwell times
 */
export default class AdjustDwellTimeComponent extends Component<void, Props, void> {
