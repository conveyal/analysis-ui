    ...
    return (
      <div>
        ...
        <div className='form-group'>
          <label htmlFor='Scale' className='radio-inline'>
            <input type='radio' value='scale' checked={modification.scale} onChange={this._setScale} />Scale existing dwell times by
          </label>
          <label htmlFor='Speed' className='radio-inline'>
            <input type='radio' value='speed' checked={!modification.scale} onChange={this._setSpeed} />Set new dwell time to
          </label>
        </div>
