...
import type {GTFSStop, Modification, MapState, Stop} from '../../types'
      ...
      <div>
        <div className='form-group'>
          ...
          <div className='btn-group btn-group-justified'>
            <a
              className={
                someStopsSelected ? disabledButtonClass : defaultBtnClass
              }
            ...
            <a
              className={
                someStopsSelected ? defaultBtnClass : disabledButtonClass
              }
