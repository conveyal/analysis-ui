...
export default class SegmentSpeeds extends DeepEqual {
  ...
  componentWillReceiveProps (nextProps) {
    if (nextProps.segmentDistances !== this.props.segmentDistances) {
      this._setSegmentSpeedsLengthTo(nextProps.segmentDistances.length)
    }
  ...
  componentDidMount () {
    ...
    if (segmentDistances.length !== segmentSpeeds.length) {
      this._setSegmentSpeedsLengthTo(segmentDistances.length)
    }
  }

  _setSegmentSpeedsLengthTo (newLength) {
