...
import {secondsToMmSsString} from 'lib/utils/time'
import {
...
export default class SegmentSpeeds extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Group label={message('modification.dwellTimeDefault')}>
          <MinutesSeconds onChange={this._setDwell} seconds={dwellTime} />
        </Group>
        ...
        />
        <Group label={message('modification.addedSegments.time')}>
          <MinutesSeconds
