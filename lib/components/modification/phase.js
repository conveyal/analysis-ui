...
import type {
  ClearableReactSelectResult,
  GTFSStop,
  TimetableWithModification
} from '../../types'
...
const getSelectedTimetable = ({availableTimetables, phaseFromTimetable}): void | TimetableWithModification =>
  availableTimetables.find((tt) => phaseFromTimetable && tt.id === phaseFromTimetable.split(':')[1])
