...
export default class Phase extends Component {
  ...
  render () {
    ...
    return <div>
      ...
      {phaseFromTimetable && selectedTimetable.headwaySecs !== timetableHeadway &&
      <div className='alert alert-danger' role='alert'>{messages.phasing.headwayMismatchWarning}</div>}
      ...
      {phaseFromTimetable && (!selectedPhaseFromTimetableStops || selectedPhaseFromTimetableStops.length === 0) &&
