          ...
          <div>
            <FormGroup>
              ...
              <Group justified>
                ...
                <Button block disabled={modification.fromStop == null} onClick={this._clearFromStop} style='danger'>
              ...
              <Group justified>
                ...
                <Button block disabled={modification.toStop == null} onClick={this._clearToStop} style='danger'>
                  <Icon type='times' /> {message('common.clear')}
                </Button>
              </Group>
            </FormGroup>
