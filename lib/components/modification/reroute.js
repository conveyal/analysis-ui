...
import type {Feed, MapState, Reroute, RoutePatterns, Stop} from '../../types'
...
export default class RerouteComponent extends Component<void, Props, void> {
  ...
  render () {
    ...
    const fromStopLabel = `From stop: ${modification.fromStop
      ? selectedFeed.stopsById[modification.fromStop].stop_name
      : '(none)'}`
    const toStopLabel = `To stop: ${modification.toStop
      ? selectedFeed.stopsById[modification.toStop].stop_name
      : '(none)'}`
