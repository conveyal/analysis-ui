...
export default class EditAlignment extends PureComponent {
  ...
  _getTripPatternHelperText (): { error: boolean, textHtml: any} {
    const {modification, numberOfStops, segmentDistances} = this.props
  ...
  render () {
    ...
    const {error, textHtml} = this._getTripPatternHelperText()
