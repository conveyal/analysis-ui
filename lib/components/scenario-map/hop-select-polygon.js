...
import type {Feed, MapState, Modification} from '../../types'

type Props = {
  action: string,
  feed: Feed,
  modification: Modification,
  replaceModification(Modification): void,
 ...
 */
export default class HopSelectPolygon extends MapControl<void, Props, void> {
  createLeafletElement () {
    return new DrawPolygon(this.doSelect)
  }

  doSelect = (polygon: Object) => {
