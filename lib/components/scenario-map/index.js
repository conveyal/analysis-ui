...
import type {Feed, LonLat, MapState, Modification} from '../../types'
    ...
    return <FeatureGroup>
      ...
      {modificationsOnMap
        ...
        .map((m) => <RerouteLayer
          ...
          modification={m}
          showAddedSegment={!activeModification || activeModification.id !== m.id}
          />
        )}
      ...
      {modificationsOnMap
        ...
        .map((m) => <AddTripPatternLayer
          ...
          highlightSegment={mapState.state === MAP_STATE_HIGHLIGHT_SEGMENT ? mapState.segmentIndex : -1}
          highlightStop={mapState.state === MAP_STATE_HIGHLIGHT_STOP ? mapState.stopIndex : -1}
          segments={m.segments} />
        )}
