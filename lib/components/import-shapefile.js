...
export default class ImportShapefile extends DeepEqual {
  static propTypes = {
  ...
  changeStopSpacingMeters = e => {
    ...
    this.setState(
      Object.assign({}, this.state, {stopSpacingMeters: Number(e.target.value)})
    )
  }
  ...
  changeBidirectional = e => {
    this.setState(
      Object.assign({}, this.state, {bidirectional: e.target.checked})
    )
  }

  changeAutoCreateStops = e => {
    this.setState(
      Object.assign({}, this.state, {autoCreateStops: e.target.checked})
    )
  }
