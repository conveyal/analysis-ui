 ...
 */
export default class RerouteLayer extends PureComponent {
  static defaultProps = {
  ...
  render() {
    const {dim, showAddedSegment} = this.props
    const {
      addedSegments,
      feedsLoaded,
      patterns,
...
RerouteLayer.getDerivedStateFromProps = ({dim, feed, modification}) => {
  const addedSegments = {
