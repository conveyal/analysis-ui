...
export default class EditProject extends Component<void, Props, State> {
  ...
  componentWillReceiveProps (nextProps: any) {
    this.setState({...nextProps, saving: nextProps.loadStatus && nextProps.loadStatus !== 'DONE'})
  }
