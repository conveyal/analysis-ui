...
export const Group = pure(function ButtonGroup ({children, justified}) {
...
export const Button = pure(function Button ({block, children, className, onClick, size, style, href = '#', target, ...props}) {
