...
export const Group = pure(({children, justified, vertical, radio}) => {
...
export const Button = pure(({block, children, className, onClick, size, style, href = '#', target, name, value, checked, radio, ...props}) => {
