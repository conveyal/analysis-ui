...
const getMainIsochroneKey = memoize((data, isCurrent) => uuid.v4())
const getCompIsochroneKey = memoize((data, isCurrent) => uuid.v4())
...
export default class AnalysisMap extends React.Component {
  ...
  static getDerivedStateFromProps (props, state) {
    ...
    return {
      ...
      compIsochroneKey: getCompIsochroneKey(props.comparisonIsochrone, isCurrent)
    }
  }
