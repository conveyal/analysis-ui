...
export default class BookmarkChooser extends Component<void, Props, State> {
  state = {
    bookmarkName: '',
  ...
  prepareCreateBookmark = () => this.setState({creatingBookmark: true})
  ...
  createBookmark = () => {
    ...
    if (isochroneLonLat) {
      ...
      window.alert(
        'Please verify analysis has been successful before creating a bookmark.'
      )
    }
  }
  ...
  render () {
    ...
    return creatingBookmark
      ? this.renderBookmarkCreate()
      : this.renderBookmarkSelect()
  }
  ...
  renderBookmarkSelect () {
    ...
    return (
      <div>
        ...
        <Button
          onClick={this.prepareCreateBookmark}
