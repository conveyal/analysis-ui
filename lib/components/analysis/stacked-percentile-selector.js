...
export default class StackedPercentileSelector extends PureComponent {
  ...
  state: {
    selection: 'project' | 'base' | 'comparison'
  }
  ...
  _selectView = memoize((selection: string) => () => this.setState({selection}))
    ...
    return (
      <div className='block'>
        ...
        <ButtonGroup justified>
          <Button
            active={noComparison || selection === PROJECT}
        ...
        {percentileCurves &&
          <StackedPercentile
            ...
            selected={comparisonPercentileCurves ? selection : PROJECT}
            label={projectName}
