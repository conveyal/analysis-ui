...
export default class StackedPercentileSelector extends PureComponent {
  ...
  _selectView = memoize((scenarioPlotted: string) => () =>
  ...
  render() {
    ...
    return (
      <div>
        ...
        {stale && <h5>{message('analysis.willUpdate')}</h5>}
        <input
        ...
        {accessibility !== null && (
          <div className='progress'>
            ...
            <div className='statistic'>{commaFormat(accessibility)}</div>
          </div>
        )}
        ...
        {comparisonInProgress &&
          ...
          comparisonAccessibility != null && (
            <div className='progress'>
              ...
              >
                <div className='project-name'>{`${comparisonProjectName}`}</div>
              </div>
