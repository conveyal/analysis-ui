  ...
  render () {
    ...
    return (
      <div>
        ...
        <Group label={message('analysis.selectPercentileOfAccessibility')}>
          <Slider
...
function AggregateAccessibilityReadout ({
  ...
  return (
    <div>
      {sprintf(message('analysis.percentileOfAccessibility'), {
        name,
        weightByName,
        accessToName,
      ...
      <Icon
        ...
        title={message('analysis.weightedAverageAccessibilityWarning')}
      />
      {sprintf(
