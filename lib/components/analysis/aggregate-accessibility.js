...
> {
  ...
  renderPlot () {
    ...
    return (
      <svg width={WIDTH} height={HEIGHT}>
        {this.renderBins(
          aggregateAccessibility.bins,
          aggregateAccessibility.percentiles,
        ...
        {comparisonAggregateAccessibility &&
          <g>
            {this.renderBins(
              comparisonAggregateAccessibility.bins,
              comparisonAggregateAccessibility.percentiles,
      ...
      <g>
        {this.yScale.ticks(4).map((t, i) =>
          <text
            ...
            transform={`translate(${Y_SCALE_WIDTH} ${this.yScale(
              t
            )}) rotate(-30)`}
          >
            {fmt(t)}
  ...
  renderPercentileReadout () {
    ...
    const accessibilityForPercentile =
      comparisonAggregateAccessibility.percentiles[percentileOfAccessibility]
    return (
      <div>
        ...
        {comparisonAggregateAccessibility &&
          <AggregateAccessibilityReadout
            ...
            // experienced by 10% of the population
            percentage={100 - percentileOfAccessibility}
            accessibilityForPercentile={accessibilityForPercentile}
