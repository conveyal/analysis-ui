...
const ALL = 'ALL'
const ALL_TRANSIT_ARRAY = [BUS, RAIL, TRAM, SUBWAY, FERRY, CABLE_CAR, GONDOLA, FUNICULAR]
...
export default class ModeSelector extends Component {
  ...
  _hasAllTransit () {
    return ALL_TRANSIT_ARRAY.map(mode => this.props.transitModes.indexOf(mode) !== -1)
      .every(Boolean)
  }
