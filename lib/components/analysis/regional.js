...
> {
  ...
  changeAggregationAreaFiles = (e: Event & {target: {files: FileList}}): void => {
    ...
    return (
      <div className='block'>
        ...
        <Group label={messages.analysis.gisExport}>
          <Button
            block
            onClick={this.downloadScenarioGIS}
            style='info'
          ...
          {comparisonAnalysis &&
            <Button
              block
              onClick={this.downloadComparisonGIS}
              style='info'
              >{sprintf(
          ...
          {comparisonAnalysis &&
            <Button
              block
              onClick={this.downloadProbabilityGIS}
              style='info'
