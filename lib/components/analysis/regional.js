  ...
  render () {
    ...
    return <div>
      ...
      { comparisonAnalysis && <div>
        <i>
          {comparisonAnalysis.travelTimePercentile !== -1 && sprintf(messages.analysis.accessTo, {
          ...
          {comparisonAnalysis.travelTimePercentile === -1 && sprintf(messages.analysis.accessToInstantaneous, {
            opportunity: indicators.find(i => i.key === comparisonAnalysis.grid).name,
            cutoff: comparisonAnalysis.cutoffMinutes
          })}
        </i>
