...
export default class RegionalAnalysisDisplay extends Component<void, Props, void> {
  ...
  renderAggregation () {
    const {masks, maskId, indicators, maskWeightsId, aggregateAccessibility, comparisonAggregateAccessibility, comparisonAnalysis, maskUploading, analysis} = this.props
