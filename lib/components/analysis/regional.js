...
import type {RegionalAnalysis, Grid, AggregationArea, ReactSelectOptions, Indicator} from '../../lib/types'
...
type Props = {
  ...
  aggregationAreaWeightsId: ?string,
  ...
  setAggregationArea: (string) => void,
  setAggregationWeights: (string) => void,
  uploadAggregationArea: (arg: {name: string, files: HTMLFileElement[], projectId: string}) => void,
...
export default class RegionalAnalysisDisplay extends Component<void, Props, void> {
  ...
  uploadAggregationArea = (e: Event): void => {
    ...
    this.setState({ aggregationArea: null, aggregationAreaFiles: null, showAggregationAreaUpload: false })
  }
  ...
  renderAggregation () {
    ...
    return <div>
      ...
      {aggregateAccessibility && <AggregateAccessibility
        ...
        weightByName={indicators.find(indicator => indicator.key === aggregationWeightsId).name}
        accessToName={indicators.find(indicator => indicator.key === analysis.grid).name}
        regionalAnalysisName={analysis.name}
        comparisonAccessToName={comparisonAnalysis && indicators.find(indicator => indicator.key === comparisonAnalysis.grid).name}
