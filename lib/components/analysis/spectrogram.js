...
export default class Spectrogram extends Component {
  ...
  draw = () => {
    let { data, isochroneCutoff, scale, width, height, indicator, positiveColors, positiveColorStops, negativeColors, negativeColorStops, textColor, bins, difference } = this.props
