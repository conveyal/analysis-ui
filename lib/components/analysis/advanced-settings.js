...
export default class AdvancedSettings extends Component {
  ...
  renderRegionalAnalysisBoundsSelector (disableInputs: boolean) {
    ...
    const options = [
      ...
      ...regionalAnalyses
        .filter(r => !boundsEqual(webMercatorBoundsToGeographic(r), regionBounds))
        .map(({name, _id}) => ({
          value: _id,
      ...
      <section className='panel panel-default inner-panel advanced-panel'>
        ...
        >
          ...
          <Icon
            ...
            type={s.advancedSectionCollapsed ? 'caret-right' : 'caret-down'}
          />
        </a>
          ...
          <div className='panel-body'>
            <div className='row'>
              <div className='col-xs-4'>
                <EgressModeSelector
                  disabled={p.disabled}
                  egressModes={p.profileRequest.transitModes !== ''
              ...
              <div className='col-xs-12'>
                <Group label={message('analysis.customizeProfileRequest.label')}>
                  ...
                  <Button
                    ...
                    style='warning'
                  ><Icon type='pencil' /> {message('analysis.customizeProfileRequest.update')}
                  </Button>
                </Group>
              </div>
            </div>
