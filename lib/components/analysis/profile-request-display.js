...
export default class ProfileRequestDisplay extends Component {
  ...
  render () {
    ...
    const transit = request.transitModes !== ''
    return (
      <table className='table table-striped table-condensed'>
        <tbody>
          ...
          <tr>
            ...
            <td>
              {this.renderModes(
                transit ? request.accessModes : request.directModes
              )}
            </td>
          </tr>
          <tr>
