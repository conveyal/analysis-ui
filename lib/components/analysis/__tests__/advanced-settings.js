...
import {mockProfileRequest, mockRegion, mockWithProvider} from '../../../utils/mock-data'

describe('Components > Analysis > Advanced Settings', () => {
  const props = {
    addEditRegionalAnalysisBoundsLayerToMap: jest.fn(),
    disabled: false,
    profileRequest: mockProfileRequest,
    regionalAnalyses: [],
    regionBounds: mockRegion.bounds,
    removeEditRegionalAnalysisBoundsLayerFromMap: jest.fn(),
