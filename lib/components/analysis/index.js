      ...
      <div>
        ...
        <div className='Fullscreen analysisMode'>
          <Map onClick={this._clickMap}>
            ...
            <Marker
              draggable={!disableInputs}
              opacity={disableInputs ? 0.5 : 1.0}
            ...
            >
              {!currentProject &&
                <Tooltip permanent>
                  <span>{message('analysis.disableFetch')}</span>
                </Tooltip>}
            </Marker>
        ...
        <div className='ApplicationDock analysisMode'>
          <div className='ApplicationDockTitle'>
            ...
            {typeof isochroneFetchStatus === 'string'
              ? message(`analysis.fetchStatus.${isochroneFetchStatus}`)
              : 'Analysis'}
