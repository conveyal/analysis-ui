...
export default class SinglePointAnalysis extends Component {
  ...
  render () {
    const { currentIndicator, indicators, accessibility, isochroneCutoff, spectrogramData, variantName, projectId, scenarioName, isFetchingIsochrone, uploadGrid } = this.props
