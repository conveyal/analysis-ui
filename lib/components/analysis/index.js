...
export default class SinglePointAnalysis extends Component {
  ...
  renderResults () {
    ...
    return (
      <div>
        <div className='DockTitle'>Accessibility</div>
        ...
        <div className='block'>
          ...
          {comparisonInProgress && comparisonAccessibility != null && currentIndicator && <h6>
            {sprintf(messages.analysis.accessibility, {
    ...
    return (
      <div>
        <div className='block'>
          ...
          <Group id='select-analysis-indicator' label='Indicator'>
            <Select
          ...
          <Button
            ...
            style='info'
            >{isFetchingIsochrone
              ? <span><Icon type='refresh' className={isFetchingIsochrone ? 'fa-spin' : ''} /> {messages.analysis.fetchStatus[isochroneFetchStatusMessage]}</span>
              : <span><Icon type='refresh' /> {messages.analysis.refresh}</span>}
          </Button>
        </div>
  ...
  renderComparisonSelect () {
    ...
    return (
      <div>
        <Group label='Compare to another scenario'>
          <Select
