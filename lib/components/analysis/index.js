...
export default class SinglePointAnalysis extends React.PureComponent {
  ...
  _setFromLonLat() {
    ...
    if (p.profileRequest.fromLat == null || p.profileRequest.fromLon == null) {
      console.log('SETTING PROFILE REQUEST')
      console.log(p.profileRequest, p.profileRequestLonLat)
      p.setProfileRequest({
            ...
            {p.isochrone && (
              <>
                <ButtonGroup justified>
                  ...
                  <Button
                    disabled={!p.comparisonIsochrone || !displayedDataIsCurrent}
