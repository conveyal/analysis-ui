...
export default class StopLayer extends Path {
  ...
  render () {
    ...
    if (!this.props.data.has(this.props.modification.feed) || this.props.modification.routes == null) return ret

    let patterns = this.props.data.get(this.props.modification.feed).routes.get(this.props.modification.routes[0]).patterns
