...
export default class ScenarioMap extends Component {
  static propTypes = {
    ...
    lastModifiedModificationId: PropTypes.string,
  ...
  render () {
    const {bundle, data, lastModifiedModificationId, mapState, modifications} = this.props
    ...
    const dim = (id) => lastModifiedModificationId !== id
