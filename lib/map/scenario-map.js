...
export default class ScenarioMap extends Component {
  ...
  render () {
    ...
    return <LeafletMap
      ...
      {modificationsOnMap
        ...
        .filter((m) => m.type === 'add-trip-pattern' && (mapState.modification === undefined || mapState.modificationId !== m.id))
  ...
  renderStateSpecificLayers () {
    ...
    if (mapState.state === 'stop-selection') {
      ...
      return <TransitEditor modification={m} replaceModification={replaceModification} data={data} />
