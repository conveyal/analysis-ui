...
export const reducers = {
  ...
  'set active modification' (state, action) {
    ...
    const activeModification = state.activeModification;
    const newActive = (!activeModification || activeModification.id !== modification.id) ? modification : null

    return {
      ...state,
      activeModification: newActive
    }
  },
