...
export const reducers = {
  ...
  'set mask weights id' (state, action) {
    return {
      ...state,
      regional: {
        ...state.regional,
        maskWeightsId: action.payload
      }
    }
  },
  'set mask weights' (state, action) {
    return {
      ...state,
      regional: {
        ...state.regional,
        maskWeights: action.payload
      }
    }
  },
  'set mask uploading' (state, action) {
    return {
      ...state,
      regional: {
        ...state.regional,
        maskUploading: action.payload
      }
    }
  },
