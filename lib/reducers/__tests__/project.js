...
describe('reducers > project', () => {
  ...
  it('should handle delete regional analysis', () => {
    const mockProjectWithRegionalAnalyses = { ...mockProject, regionalAnalyses: mockRegionalAnalyses }
    const storeWithProjectSet = reducer(undefined, { type: 'set project', payload: mockProjectWithRegionalAnalyses })
    const action = {
      type: 'delete regional analysis',
      payload: 'abcd'
    }
    expect(reducer(storeWithProjectSet, action)).toMatchSnapshot()
  })
})
