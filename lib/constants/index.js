 ...
 * API URLs
 */
export const URL_BASE_PATH = process.env.API_URL
...
export const RouteTo = {
  ...
  opportunitiesUpload: '/opportunities-upload',
  importShapefile: '/import-shapefile',
  modificationEdit: '/modification-edit',
  modificationImport: '/modification-import',
