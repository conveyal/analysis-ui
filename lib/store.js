...
import { SET_PROJECT, SET_BUNDLE, SET_USER_PROFILE, REPLACE_MODIFICATION, UPDATE_DATA, DELETE_MODIFICATION, ADD_LAYER, REMOVE_LAYER, ADD_CONTROL, REMOVE_CONTROL, LOAD_PROJECTS, SET_MAP_STATE } from './action-types'
...
let initialState = {
  ...
  sessionToken: storedState.sessionToken || null
}

/** the main reducer */
function reduce (state = initialState, action) {
  if (action.type === SET_USER_PROFILE) {
    state = Object.assign({}, state, { user: action.payload.profile, sessionToken: action.payload.token })
