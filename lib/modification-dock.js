...
import Panel, {Body as PanelBody} from './components/panel'
...
class ModificationDock extends DeepEqual {
  static propTypes = {
  ...
  render () {
    const {allVariants, feeds, feedsById, modification, mapState, name, 
           setActiveTrips, setMapState, type, variants} = this.props 
    const props = {
      feeds,
      feedsById,
      mapState,
