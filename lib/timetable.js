...
export default class Timetable extends TimetableEntry {
  ...
  render () {
    return (
      <form>
        <legend>Timetable #{this.props.index}</legend>
        {super.render()}
        <div className='form-group'>
          <label>Speed (km/h):</label>
          <input type='text' className='form-control' value={this.props.timetable.speed} onChange={this.setSpeed} />
        </div>
        <div className='form-group'>
          <label>Dwell time (seconds):</label>
          <input type='text' className='form-control' value={this.props.timetable.dwellTime} onChange={this.setDwell} />
        </div>
      </form>
    )
  }
