...
export default class FrequencyEntry extends TimetableEntry {
  ...
  render () {
    const {addLayer, feed, feedsById, routes} = this.props
    return (
      <div className='panel panel-default inner-panel' onFocus={() => this.props.setActiveTrips(this.props.timetable.patternTrips)}>
