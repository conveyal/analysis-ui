...
export default class AdjustSpeed extends Component {
  ...
  render () {
    return <div>
      ...
      <label><input type='radio' name='scaleOrSpeed' value='scale' checked={this.props.modification.scale} onChange={this.setScale} />Scale existing speeds by</label>
      <label><input type='radio' name='scaleOrSpeed' value='speed' checked={!this.props.modification.scale} onChange={this.setSpeed} />Set new speed to</label>
