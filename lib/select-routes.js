    ...
    return (
      <div>
        <div className='form-group'>
          <label>Feed</label>
          <select className='form-control' value={this.props.feed} onChange={this.selectFeed}>
            <option></option>
  ...
  renderRoutes () {
    ...
    if (this.props.feed && this.props.data.feeds.has(this.props.feed)) {
      return (
        <div className='form-group'>
          <label>Route</label>
          <select className='form-control' value={this.props.routes ? this.props.routes[0] : undefined} onChange={this.selectRoute}>
            <option></option>
