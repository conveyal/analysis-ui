...
export default class Routes extends React.Component {
  ...
  _loadOpportunityDatasets = (nextState: any) => {
    this.props.store.dispatch(
      OpportunityDatasets.actions.loadOpportunityDatasets(
        nextState.params.regionId
      )
    )
  }
        ...
        <Route path='/' onEnter={this._checkAuthentication}>
          ...
          >
            ...
            <Route
              ...
              onEnter={this._loadOpportunityDatasets}
            />
