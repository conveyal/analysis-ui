...
import {fetchTravelTimeSurface, setComparisonScenario, setComparisonInProgress, setIsochroneCutoff, setCurrentIndicator, enterAnalysisMode, exitAnalysisMode, setActiveVariant, clearIsochroneResults, setProfileRequest} from '../actions/analysis'
...
import {accessibility, comparisonAccessibility} from '../selectors/accessibility'
import {spectrogramData, comparisonSpectrogramData} from '../selectors/spectrogram-data'
...
function mapStateToProps (state, params) {
  ...
  return {
    ...
    comparisonAccessibility: comparisonAccessibility(state),
    ...
    comparisonSpectrogramData: comparisonSpectrogramData(state),
    comparisonVariant: analysis.comparisonVariant,
    currentIndicator: analysis.currentIndicator,
    desinationGrid: analysis.destinationGrid,
    ...
    spectrogramData: spectrogramData(state),
