...
function mapStateToProps (state, ownProps) {
  ...
  const currentProject = selectCurrentProject(state, ownProps) || {}
  return {
    ...
    modifications: selectModifications(state, ownProps).filter(m => m.variants[variantId]),
    ...
    projectBounds: currentProject.bounds,
    ...
    workerVersion: currentProject.r5Version
  }
}
