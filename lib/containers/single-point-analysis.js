  ...
  return {
    ...
    regionalAnalyses:
      project.regionalAnalyses != null
        ? project.regionalAnalyses.filter(
            a =>
...
function mapDispatchToProps (dispatch, props) {
  return {
    ...
    loadRegionalAnalyses: projectId =>
      dispatch(loadRegionalAnalyses(projectId)),
    ...
    selectRegionalAnalysis: (projectId, scenarioId, regionalAnalysisId) =>
      dispatch(
        push(`/scenarios/${scenarioId}/analysis/regional/${regionalAnalysisId}`)
      ),
