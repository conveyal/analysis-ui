...
import StackedPercentileSelector from '../components/analysis/stacked-percentile-selector'
import selectAccessibility from '../selectors/accessibility'
import selectComparisonAccessibility from '../selectors/comparison-accessibility'
...
import selectComparisonPercentileCurves from '../selectors/comparison-percentile-curves'
...
function mapStateToProps (state, ownProps) {
  ...
  return {
    ...
    comparisonPercentileCurves: selectComparisonPercentileCurves(state, ownProps),
    comparisonScenarioName,
    indicatorName: analysis.currentIndicator,
...
export default connect(mapStateToProps, mapDispatchToProps)(StackedPercentileSelector)
