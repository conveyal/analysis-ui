...
import selectActiveModificationId from '../selectors/active-modification-id'
...
import selectProjectIsLoaded from '../selectors/project-is-loaded'
...
function mapStateToProps (state, props) {
  ...
  const projectId = selectProjectId(state, props)
  return {
    activeModificationId: selectActiveModificationId(state, props),
    ...
    projectId,
    projectIsLoaded: selectProjectIsLoaded(state, props),
