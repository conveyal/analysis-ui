...
function mapStateToProps (state, ownProps) {
  ...
  return {
    ...
    bundleId: selectCurrentBundle(state, ownProps).id,
...
function mapDispatchToProps (dispatch) {
  return {
    fetchTravelTimeSurface: req =>
      dispatch(fetchTravelTimeSurface({...req, dispatch})),
    ...
    setIsochroneCutoff: isochroneCutoff =>
      dispatch(setIsochroneCutoff(isochroneCutoff))
  }
}
