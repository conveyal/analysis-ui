...
import selectDestinationTravelTimeDistribution
  from '../selectors/destination-travel-time-distribution'
import selectComparisonDestinationTravelTimeDistribution
  from '../selectors/comparison-destination-travel-time-distribution'
...
function mapStateToProps (state: any) {
  ...
  return {
    destination,
    isFetchingIsochrone,
    destinationTravelTimeDistribution: selectDestinationTravelTimeDistribution(
      state
    ),
    comparisonDestinationTravelTimeDistribution: selectComparisonDestinationTravelTimeDistribution(
      state
    )
  }
}
