...
function mapStateToProps (state, ownProps) {
  ...
  const projectId = selectCurrentProjectId(state, ownProps)
  ...
  return {
    ...
    regionalAnalyses: state.project.regionalAnalyses,
    scenarioId: selectCurrentScenarioId(state, ownProps),
    projectId,
    comparisonAnalysis: state.project.regionalAnalyses != null
      ? state.project.regionalAnalyses.find(
    ...
    opportunityDatasets: project.opportunityDatasets,
    aggregationAreas: project.aggregationAreas,
