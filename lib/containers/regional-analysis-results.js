...
import {REGIONAL_COMPONENT, REGIONAL_COMPARISON_COMPONENT, ISOCHRONE_COMPONENT, OPPORTUNITY_COMPONENT, AGGREGATION_AREA_COMPONENT} from '../constants/map'
...
function mapStateToProps (state, ownProps) {
  ...
  return {
    ...
    comparisonAggregateAccessibility: selectComparisonAggregateAccessibility(state)
  }
}
...
function mapDispatchToProps (dispatch, ownProps) {
  return {
    ...
    addAggregationAreaComponentToMap: () => dispatch(addComponent(AGGREGATION_AREA_COMPONENT)),
    removeAggregationAreaComponentFromMap: () => dispatch(removeComponent(AGGREGATION_AREA_COMPONENT)),
    ...
    setAggregationArea: ({ projectId, aggregationAreaId }) => dispatch(setAggregationArea({ projectId, aggregationAreaId })),
    setAggregationWeights: ({ projectId, aggregationWeightsId }) => dispatch(setAggregationWeights({ projectId, aggregationWeightsId })),
    uploadAggregationArea: ({ name, files, projectId }) => dispatch(uploadAggregationArea({ name, files, projectId }))
  }
}
