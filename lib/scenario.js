...
class Scenario extends Component {
    ...
    return (
      <div>
        <div className='ModificationGroup'>
          <Title>Variants <Button className='pull-right' onClick={this.newVariant} style='success'><Icon type='plus' /></Button></Title>
  ...
  renderModificationGroup (title, onClick, modifications) {
    return (
      <div className='ModificationGroup'>
        <Title>{title} <Button className='pull-right' onClick={onClick} style='success'><Icon type='plus' /></Button></Title>
