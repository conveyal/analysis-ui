...
import ConvertToFrequency, { create as createConvertToFrequency } from './convert-to-frequency'
  ...
  render () {
    ...
    return (
      <div>
        ...
        <ul>
          {convertToFrequency.map(c => <ConvertToFrequency modification={c} key={c.id} replaceModification={this.props.replaceModification} 
              addLayer={this.props.addLayer} removeLayer={this.props.removeLayer} addControl={this.props.addControl} removeControl={this.props.removeControl} />)}
        </ul>
