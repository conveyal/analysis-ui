...
import {set as setScenario} from './actions/scenario'
...
class Application extends Component {
  ...
  render () {
    const {currentBundle, currentProject, currentScenario, feeds, login, logout, outstandingRequests, push, userIsLoggedIn} = this.props
