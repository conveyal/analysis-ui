...
export default class SelectRouteAndPatterns extends Component {
  ...
  constructor (props) {
    ...
    this.selectRoute = this.selectRoutes.bind(this)
  ...
  selectRoutes ({ routes, feed }) {
    this.props.onChange(Object.assign({}, this.props, { routes, feed }))
  }

  render () {
    return <div>
      <SelectRoutes routes={this.props.routes} feed={this.props.feed} onChange={this.selectRoutes} />
      ...
      {this.props.routes && this.props.routes.length === 1 ?
        <SelectPatterns addLayer={this.props.addLayer} removeLayer={this.props.removeLayer} onChange={this.selectTrips}
          feed={this.props.feed} routes={this.props.routes} trips={this.props.trips}
