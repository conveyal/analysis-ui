...
export const mockStores = {
  init: {
    ...
    opportunityDatasets: {
      ...
      datasets: mockProject.opportunityDatasets,
      uploadStatuses: []
    },
    project: {
