...
function mapStateToProps (state) {
  return {
    ...
    lastModifiedModificationId: state.scenario.lastModifiedModificationId,
...
class ScenarioEditor extends Component {
  ...
  render () {
    const {bundleId, createVariant, data, lastModifiedModificationId, login, logout, mapState, modifications, name, push, setMapState, updateVariant, user} = this.props
      ...
      <div>
        ...
        <div
          ...
          <ScenarioMap
            ...
            data={data}
            lastModifiedModificationId={lastModifiedModificationId}
            mapState={mapState}
