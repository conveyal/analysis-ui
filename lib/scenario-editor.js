...
import {deleteBundle, setBundle, setMapState, setProject, setUser, updateVariants} from './actions'
import {REPLACE_MODIFICATION, DELETE_MODIFICATION} from './actions/types'
...
class ScenarioEditor extends Component {
  ...
  renderProjectSelectModal () {
    const {data, projects, modifications, replaceModification, setBundle, variants} = this.props
