...
import { SET_PROJECT, SET_BUNDLE, SET_USER, REPLACE_MODIFICATION, UPDATE_DATA, DELETE_MODIFICATION, SET_MAP_STATE, UPDATE_VARIANTS } from './actions/types'
  ...
  return bindActionCreators({
    ...
    setProject: function (project) {
      ...
      getDataForModifications({ modifications: [...project.modifications.values()], bundleId: project.bundleId })
        ...
        .catch((err) => {
          console.error(err)
          window.alert('Error setting project!')
        })
    ...
    setBundle: function (bundleId) {
      ...
      getDataForModifications({ modifications: store.getState().modifications.values(), bundleId })
        ...
        .catch((err) => {
          console.error(err)
          window.alert('Error setting bundle!')
        })
    ...
    replaceModification: function (modification) {
      ...
      getDataForModifications({ modifications: [...state.modifications.values(), modification], bundleId: state.bundleId })
        ...
        .catch((err) => {
          console.error(err)
          window.alert('Error replacing modification!')
        })
...
class ScenarioEditor extends Component {
  ...
  logout = (e) => {
    this.props.setUser({access_token: null, id_token: null, profile: null, refresh_token: null})
