...
export default class ConvertToFrequency extends Component {
  ...
  render () {
    return <div>
      ...
      <SelectRoutes feed={this.props.modification.feed} routes={this.props.modification.routes} onChange={this.onRouteChange} />
      ...
      {this.props.modification.entries.map((entry, eidx) => {
        return <FrequencyEntry feed={this.props.modification.feed} routes={this.props.modification.routes}
          addLayer={this.props.addLayer} removeLayer={this.props.removeLayer} key={eidx}
