...
export default class AddStops extends Component {
  ...
  setSpeed (e) {
    let mod = Object.assign({}, this.props.modification, { speed: Number(e.target.value) })
    this.props.replaceModification(mod)
  }

  setDwell (e) {
    let mod = Object.assign({}, this.props.modification, { dwell: Number(e.target.value) })
    this.props.replaceModification(mod)
  }
  ...
  render () {
    return <div>
      ...
      <br/>
      <label>Speed (km/h): <input type='number' step='any' value={this.props.modification.speed} onChange={this.setSpeed} /></label><br/>
      <label>Dwell time (seconds): <input type='number' step={1} value={this.props.modification.dwell} onChange={this.setDwell} /></label><br/>
